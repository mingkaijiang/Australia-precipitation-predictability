Calculate_temperature_predictability_fixed_bin <- function(sourceDir, destDir) {
    ...
    decile.list <- c(-10, 0, 5, 10, 15, 20, 25, 30, 35, 40, 50)
    ...
    ### save output
    saveRDS(out, paste0(destDir, "/Australia_temperature_predictability_fixed_bin.rds"))
