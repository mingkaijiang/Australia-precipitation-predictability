...
Make_basic_plots_0.1_degree_resolution(infile="output_rainfall_decile/Australia_rainfall_predictability_quantile.rds",
                                       outfile="basic_rainfall_plots_quantile")
